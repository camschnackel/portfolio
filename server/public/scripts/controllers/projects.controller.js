myApp.controller('ProjectsController', function ($scope, GithubService) {
    ...
    vm.featRepos = [
        ...
        {
            name: 'EverList',
            tech: 'HTML5, CSS3, JavaScript, jQuery, Express, PostgresSQL, Bootstrap',
            images: [],
    ...
    vm.format = 'MMM/d/yy';
    vm.modal = {};
    vm.modalToggle = function(index){
        console.log('vm.modalToggle ran!');
        vm.modal[index] = !vm.modal[index];
    }
